...
const AUDIT_SOURCE_LABELS: Record<string, string> = {
  ...
  outlook_live_sync: "Outlook Calendar sync",
  google_file_import: "Google Calendar import",
  google_live_sync: "Google Calendar sync",
  apple_file_import: "Apple Calendar import",
  apple_live_sync: "Apple Calendar sync",
