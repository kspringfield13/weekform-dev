...
function ManagerSettings({ onOpenPreferences, webAppDashboardUrl }: { onOpenPreferences: () => void; webAppDashboardUrl: string }) {
  const cards = [
    ...
    { icon: FlaskConical, title: "Simulation", copy: "Generate realistic synthetic spans or watch Weekform respond to a live work session.", action: "Open Simulation", href: "/manager-access/simulation" },
