...
mission: ABS-MINIMAL-001 · loop: loop-20260718-195935-4224b8 · type: general
...
1. Inspect the current state of the working tree before editing anything.
2. Pick one bounded strategy per iteration and see it through.
