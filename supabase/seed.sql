...
insert into public.workload_snapshots (
  ...
  ('c0000000-0000-4000-8000-000000000001', 'd0000000-0000-4000-8000-000000000001', 1,
   ...
   28, 72, 18, 24, 12, 4, 15, 42, 55, 0.82,
   '[{"category":"synthetic-analysis","pct":40},{"category":"synthetic-reporting","pct":32}]',
   '[{"mode":"focus","pct":46},{"mode":"meetings","pct":24},{"mode":"reactive","pct":18}]',
  ...
  ('c0000000-0000-4000-8000-000000000002', 'd0000000-0000-4000-8000-000000000002', 1,
   ...
   18, 82, 30, 18, 22, 8, 25, 61, 68, 0.74,
  ...
  ('c0000000-0000-4000-8000-000000000003', 'd0000000-0000-4000-8000-000000000003', 1,
   ...
   35, 65, 12, 20, 9, 2, 10, 30, 48, 0.88,
   '[{"category":"synthetic-modeling","pct":52}]',
   '[{"mode":"focus","pct":58},{"mode":"meetings","pct":20}]',
   '[{"project":"synthetic-project-atlas","pct":36},{"project":"synthetic-project-lumen","pct":16}]',
